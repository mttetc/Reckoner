...
agent yet; no recalculation of modified builds (the engine honestly reports it cannot).
...
| Never simulate a modified calculation | `PoEAdapter.recalculate` raises `EngineUnavailable`; API returns 503 |
