...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col items-center px-4 text-center">
      ...
      <p className="text-muted-foreground mt-2 max-w-xl text-sm" data-testid="welcome-hint">
        Ask in your own words, or paste a Path of Building code. Every number comes with where it comes from; when something is
        unknown, it says so.
      </p>
    </div>
  );
      ...
      <ComposerPrimitive.AttachmentDropzone asChild>
        ...
        >
          ...
          <ComposerPrimitive.Input
            placeholder="Ask about a build, or paste a Path of Building code…"
      ...
      <div className="flex items-center gap-1.5">
        ...
        <AuiIf condition={(s) => !s.thread.isRunning}>
          <ComposerPrimitive.Send asChild>
            <TooltipIconButton data-testid="ask-submit"
